...
async function main() {
  ...
  const KNOWLEDGE_DATA = [
    // ── ARTICLES ─────────────────────────────────────────────────────────────
    {
      ...
      imageUrl: '/images/panduan/poc-dari-limbah-dapur.webp',
      rewardPoint: 20,
    ...
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/arang-sekam-biochar.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/manfaat-mulsa-jerami.webp',
      rewardPoint: 20,
    ...
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/kompos-kulit-kopi.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/mengenal-pupuk-kandang.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
    ...
    },
    {
      ...
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/tips-memilih-alat-pertanian-bekas.webp',
      rewardPoint: 25,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'ALAT' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/merawat-cangkul-alat-tani-manual.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 3,
      status: 'PUBLISHED' as const,
      authorId: SELLER_2_ID,
    },
    {
      ...
      imageUrl: '/images/panduan/merawat-traktor-tangan-bekas.webp',
      rewardPoint: 30,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_2_ID,
    },
    {
      ...
      difficulty: 'MENENGAH' as const,
      imageUrl: '/images/panduan/hama-wereng-pengendalian-alami.webp',
      rewardPoint: 25,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'ALAT' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/pengendalian-tikus-sawah.webp',
      rewardPoint: 25,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_2_ID,
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'MENENGAH' as const,
      imageUrl: '/images/panduan/deteksi-penyakit-layu-cabai.webp',
      rewardPoint: 25,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/pupuk-npk-dosis-padi.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/pestisida-nabati-daun-mimba.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 3,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/budidaya-cabai-rawit-pemula.webp',
      rewardPoint: 25,
    ...
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/budidaya-tomat-organik-lahan-sempit.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'ALAT' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/sistem-tanam-jajar-legowo.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 3,
      status: 'PUBLISHED' as const,
      authorId: SELLER_2_ID,
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/manfaat-rotasi-tanaman.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/mengolah-singkong-tepung-mocaf.webp',
      rewardPoint: 25,
      estimatedReadingMinutes: 4,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
    },
    {
      ...
      category: 'OLAHAN' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/olah-kulit-pisang-jadi-keripik.webp',
      rewardPoint: 20,
      estimatedReadingMinutes: 3,
      status: 'PUBLISHED' as const,
      authorId: SELLER_2_ID,
    },
    {
      ...
      category: 'LIMBAH' as const,
      difficulty: 'PEMULA' as const,
      imageUrl: '/images/panduan/ekonomi-sirkular-pertanian.webp',
      rewardPoint: 30,
      estimatedReadingMinutes: 5,
      status: 'PUBLISHED' as const,
      authorId: SELLER_ID,
