...
const auth_1 = require("../src/infra/auth/auth");
...
const PRODUCTS_DATA = [
    {
        category: client_1.ProductCategory.PROCESSED_PRODUCT,
        sellerId: SELLER_ID,
        title: 'Beras Merah Organik Premium',
        description: 'Beras merah organik tanpa pestisida, ditanam secara alami di sawah dataran tinggi Jawa Tengah. Kaya serat dan nutrisi. Cocok untuk diet sehat.',
        price: 28000,
        stock: 200,
    ...
    },
    {
        ...
        description: 'Beras putih varietas IR64 dari Cianjur, terkenal dengan kepulenannya. Cocok untuk nasi putih sehari-hari.',
        price: 14000,
        stock: 500,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    },
    {
        ...
        description: 'Tomat cherry segar ukuran kecil manis, ditanam organik tanpa bahan kimia sintetis. Ideal untuk salad and garnish.',
        price: 18000,
        stock: 60,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    },
    {
        ...
        description: 'Jahe merah kering digiling halus, cocok untuk wedang, minuman kesehatan, dan rempah masakan. Kaya antioksidan.',
        price: 22000,
        stock: 50,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    {
        category: client_1.ProductCategory.AGRICULTURAL_WASTE,
        sellerId: SELLER_2_ID,
        title: 'Sekam Padi Bersih 50kg (Karung)',
        description: 'Sekam padi bersih hasil penggilingan padi, cocok sebagai media tanam, campuran kompos, atau bahan bakar biomassa.',
        price: 15000,
        stock: 80,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    },
    {
        ...
        description: 'Jerami padi kering, bisa digunakan sebagai pakan ternak, mulsa tanaman, atau bahan kerajinan tangan.',
        price: 5000,
        stock: 200,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    },
    {
        ...
        description: 'Pupuk kompos organik matang dari fermentasi bahan organik alami, kaya humus dan mikroba tanah. Meningkatkan kesuburan lahan pertanian.',
        price: 55000,
        stock: 40,
        condition: client_1.ProductCondition.NEW,
        status: client_1.ProductStatus.ACTIVE,
    ...
    {
        category: client_1.ProductCategory.SECONDHAND,
        sellerId: SELLER_2_ID,
        title: 'Traktor Tangan Quick G1000 Second',
        description: 'Traktor tangan merk Quick G1000 bekas pemakaian 2 tahun. Kondisi mesin diesel Kubota 8.5 HP masih sangat prima. Siap pakai bajak sawah.',
        price: 9500000,
        stock: 1,
    ...
    },
    {
        ...
        description: 'Gunting tarik pemangkas ranting pohon tinggi, kondisi bekas tapi pisau pemotong masih tajam. Panjang galah bisa diatur.',
        price: 120000,
        stock: 3,
        condition: client_1.ProductCondition.USED,
        status: client_1.ProductStatus.ACTIVE,
...
async function main() {
    ...
    const DEFAULT_CATEGORIES = [
        { name: 'Limbah Pertanian', slug: 'agricultural-waste', type: 'MARKETPLACE' },
        { name: 'Produk Olahan', slug: 'processed-product', type: 'MARKETPLACE' },
        { name: 'Alat Secondhand', slug: 'secondhand', type: 'MARKETPLACE' },
        { name: 'Limbah Organik', slug: 'limbah', type: 'LEARNING' },
        { name: 'Produk Olahan', slug: 'olahan', type: 'LEARNING' },
        { name: 'Alat & Mesin Tani', slug: 'alat', type: 'LEARNING' },
    ];
