...
*/
-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('agricultural-waste', 'processed-product', 'secondhand');
...
ADD COLUMN     "sellerRating" DOUBLE PRECISION NOT NULL DEFAULT 0.0,
ADD COLUMN     "totalReview" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "weight" INTEGER NOT NULL DEFAULT 1000;

-- AlterTable
ALTER TABLE "SellerProfile" ALTER COLUMN "updatedAt" DROP DEFAULT;
